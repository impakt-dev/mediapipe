...
RULES_JVM_EXTERNAL_SHA = (
    "31701ad93dbfe544d597dbe62c9a1fdd76d81d8a9150c2bf1ecf928ecdf97169"
)
...
http_archive(
    ...
    urls=[
        "https://github.com/pybind/pybind11_bazel/archive/203508e14aab7309892a1c5f7dd05debda22d9a5.zip"
    ],
)
...
http_archive(
    ...
    urls=[
        "https://github.com/google/pthreadpool/archive/b92447772365661680f486e39a91dfe6675adafc.zip"
    ],
)
...
load(
    "@org_tensorflow//third_party/xla/third_party/py:python_init_rules.bzl",
    "python_init_rules",
)
...
load(
    "@org_tensorflow//third_party/xla/third_party/py:python_init_repositories.bzl",
...
load(
    "@org_tensorflow//third_party/xla/third_party/py:python_init_toolchains.bzl",
...
load(
    "@org_tensorflow//third_party/xla/third_party/py:python_init_pip.bzl",
    "python_init_pip",
)
...
http_archive(
    ...
    urls=[
        "https://github.com/google/multichannel-audio-tools/archive/bbf15de4b7cd825d650296d21917afc07e8fe18b.tar.gz"
    ],
)
...
new_local_repository(
    ...
    # path="/usr",
    path="./opencv_build/linux",  # Use custom opencv build
)
...
new_local_repository(
    ...
    path="./opencv_build/osx",  # Use custom opencv build
)
...
new_local_repository(
    ...
    # path="C:\\opencv\\build",
    path=".\\opencv_build\\windows",  # Use custom opencv build
)
...
http_archive(
    ...
    urls=[
        "https://github.com/nothings/stb/archive/b42009b3b9d4ca35bc703f5310eedc74f584be58.tar.gz"
    ],
)
...
http_archive(
    ...
    urls=[
        "https://github.com/halide/Halide/releases/download/v15.0.1/Halide-15.0.1-x86-64-linux-4c63f1befa1063184c5982b11b6a2cc17d4e5815.tar.gz"
    ],
)
...
http_archive(
    ...
    urls=[
        "https://github.com/halide/Halide/releases/download/v15.0.1/Halide-15.0.1-x86-64-osx-4c63f1befa1063184c5982b11b6a2cc17d4e5815.tar.gz"
    ],
)
...
http_archive(
    ...
    urls=[
        "https://github.com/halide/Halide/releases/download/v15.0.1/Halide-15.0.1-arm-64-osx-4c63f1befa1063184c5982b11b6a2cc17d4e5815.tar.gz"
    ],
)
...
http_archive(
    ...
    urls=[
        "https://github.com/halide/Halide/releases/download/v15.0.1/Halide-15.0.1-x86-64-windows-4c63f1befa1063184c5982b11b6a2cc17d4e5815.zip"
    ],
)
...
http_archive(
    ...
    urls=[
        "https://github.com/google/skia/archive/226ae9d866748a2e68b6dbf114b37129c380a298.zip"
    ],
)
...
android_ndk_repository(name="androidndk", api_level=28)
